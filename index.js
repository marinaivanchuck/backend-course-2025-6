...
const storage = multer.diskStorage({
  ...
  filename: (req, file, cb) => cb(null, file.originalname) // тимчасово, перейменуємо 
});
...
// ---------------------------
// Part 1 — тестовий endpoint (залишаємо!)
// ---------------------------
app.get('/', (req, res) => {
